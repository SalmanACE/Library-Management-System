 ...
 */
public class Delete_Taken extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet rst= st.executeQuery("select ID from Taken_Books");
			while(rst.next())
			{
					...
					{
						PreparedStatement rst1= con.prepareStatement("delete from taken_Books where ID='"+sid+"'");
						rst1.executeUpdate();
						i=0;
					}
			}
